...
index = [df_it,df_us,df_jp,df_ci,df_mt,df_em,df_ge,df_gu,df_iu,df_or,df_wt,eur_gbp,eur_usd,eur_yen]
...
val_all['tipo'][4] = 'azioni_world_info_tech_usd'
val_all['tipo'][5] = 'azioni_emergenti_usd'
val_all['tipo'][6] = 'bond_governativi_eurozona'
val_all['tipo'][7] = 'bond_governativi_usa'
val_all['tipo'][8] = 'bond_corporate_usa'
val_all['tipo'][9] = 'oro'
val_all['tipo'][10] = 'wti'
val_all['tipo'][11] = 'euro_sterlina'
val_all['tipo'][12] = 'euro_dollaro'
val_all['tipo'][13] = 'euro_yen'
